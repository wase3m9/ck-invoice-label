      ...
      <div className="w-full max-w-md space-y-8">
        ...
        setPassword('');
          ...
          <TabsList className="grid grid-cols-2 w-full mb-6 overflow-hidden rounded-xl border">
            <TabsTrigger value="autolabel" className="flex items-center justify-center gap-2 py-4 data-[state=active]:bg-primary data-[state=active]:text-white transition-all duration-200 font-thin">
              <FileText className="h-5 w-5" />
              <span className="py-0 my-0 mx-0 px-0 font-medium text-sm text-center">PDF AutoLabel</span>
            </TabsTrigger>
            <TabsTrigger value="merge" className="flex items-center justify-center gap-2 py-4 data-[state=active]:bg-primary data-[state=active]:text-white transition-all duration-200">
